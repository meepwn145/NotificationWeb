...
{showNotification && (
  ...
  if (!userDetails.email) {
    ...
    // Assuming the email is stored under a key that matches what's logged
...
const sendExitNotification = async (userDetails, floorTitle, slotIndex) => {
  ...
  if (docSnap.exists()) {
    ...
    const notificationData = {
      appId: 24190, // Your Native Notify App ID
      appToken: '7xmUkgEHBQtdSvSHDbZ9zd', // Your Native Notify App Token
      ...
      subID: userDetails.email // Subscriber ID, typically the email
    };
